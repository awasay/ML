...
def main():
    ...
    if predict:
        ...
        train = pd.read_csv("../SCfeatures_train.csv")
        test = pd.read_csv("../SCfeatures_test.csv")
        Y  = train["t_train"]
        train = train.drop("t_train", axis = 1)
        test_ids = pd.read_csv("../ids.csv")
        ...
        import models
        models.EXRT(train,Y,test,test_ids,True)
